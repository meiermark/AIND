...
class PlanningGraph():
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        for precond_pos in action_a1.precond_pos:
            if precond_pos in action_a2.effect_rem:
                return True
        for precond_pos in action_a2.precond_pos:
            if precond_pos in action_a1.effect_rem:
                return True
        return False
    ...
    def inconsistent_support_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s):
        ...
        mutex_nodes = [node_a1 for node_a1 in parent_a1
                       for node_a2 in parent_a2 if node_a1.is_mutex(node_a2)]
